...
const ReviewCard = ({ name, rating, daysAgo, reviewText, profileImage }) => {
  return (
    <View>
    <View className="flex-row p-4 border-b border-gray-200">
      ...
      <View className="flex-1">
        ...
        <Text className="text-gray-500 text-sm">{daysAgo}</Text>
         
     </View>
    </View>
    <View className='px-5'>
        <Text className="text-gray-500  mt-2">{reviewText}</Text>
        </View>
    </View>
  );
};
