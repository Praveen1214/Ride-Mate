...
const SignUp = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await axios.post(`http://192.168.244.196:5000/api/passenger/register`, {
      ...
      if (response.status === 200) {
        ...
        const response = await axios.post(`http://192.168.244.196:5000/api/passenger/login`, {
          contact
        });
